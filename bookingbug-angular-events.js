...
(function() {
  ...
  angular.module('BB.Models').factory("Admin.EventChainModel", function($q, BBModel, BaseModel, EventChainService) {
...
(function() {
  ...
  angular.module('BB.Models').factory("Admin.EventGroupModel", function($q, BBModel, BaseModel, EventGroupService) {
